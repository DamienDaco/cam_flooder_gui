...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.rate_slider, 2, 0, 1, 2)
        self.lcd_number = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcd_number.setObjectName("lcd_number")
        self.gridLayout.addWidget(self.lcd_number, 0, 1, 1, 1)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 200, 23))
